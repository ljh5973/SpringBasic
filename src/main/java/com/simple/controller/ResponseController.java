...
public class ResponseController {
	...
	//가정 - 아이디 비밀번호가 동일하면 성공 화면, 다르면 다시 로그인 화면으로 이동
...
//	public String res_quiz02(@ModelAttribute("site") ReqVO vo) {
//		
//		if(vo.getId().equals("abc123") && vo.getPw().equals("1234")) {
//			
...
//	}
	...
	public ModelAndView res_login(@RequestParam("id") String id,
		...
		ModelAndView mv =new ModelAndView();
		mv.addObject("id", id);
		if(id.equals("qqq123")&& pw.equals("1234")) {	//성공
